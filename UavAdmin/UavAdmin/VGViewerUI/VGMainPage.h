...
class VGMainPage : public QObject
{
    ...
    Q_PROPERTY(int qmlRootWidth READ qmlRootWidth  NOTIFY qmlRootWidthChanged)
    Q_PROPERTY(int qmlRootHeight READ qmlRootHeight NOTIFY qmlRootHeightChanged)
    ...
    //是否横屏
    Q_PROPERTY(bool scrHoriz READ GetScreenHoriz WRITE SetScreenHoriz NOTIFY scrHorizChanged)
...
public:
    ...
    bool GetScreenHoriz()const;
    void SetScreenHoriz(bool scrHoriz);
...
public:
    static QString GetTimeString(qint64 tMs, const QString &format = "yyyy-MM-dd hh:mm:ss");
protected:
...
signals:
    ...
    void    scrHorizChanged(bool scrHor);
