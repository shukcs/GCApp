...
Rectangle {
    ...
    Rectangle {
        ...
        Label{
            ...
            text:       qsTr("Voice Setting")//qsTr("语音播报设置")
    ...
    VGSwitch {
        ...
        txtKey:  qsTr("velocity of flow")//qsTr("流速")
    ...
    VGSwitch {
        ...
        txtKey:  qsTr("Satellities")//qsTr("星数")
