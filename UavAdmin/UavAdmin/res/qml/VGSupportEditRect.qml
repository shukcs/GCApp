...
Rectangle {
    ...
    VGSliderRect {
        ...
        onFinishValue: {
            ...
            if (!vehicleMission)
                return
            if (strKey === qsTr("Height of enter support"))//起飞辅助点高度
                vehicleMission.enterHeight = val
            else if (strKey === qsTr("Height of return support"))//返航辅助点高度
    ...
    Row {
        ...
        Rectangle{
            ...
            VGValueItem{
                ...
                onClickedBtn: {
                    bEdit = true
                    slider.strHeader = qsTr("Height of enter support")//起飞辅助点高度
        ...
        Rectangle{
            ...
            Text {
                id:     txtRet
                text: qsTr("Return support")//返航辅助点
                color:  "#2C2C2C"
                font:   vgMainPage.font()
            }
            VGValueItem{
                ...
                onClickedBtn: {
                    bEdit = true
                    slider.strHeader = qsTr("Height of return support")
