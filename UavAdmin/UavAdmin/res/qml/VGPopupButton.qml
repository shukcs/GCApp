...
VGToolButton {
    ...
    property point pntPos: mapToGlobal(0,0)
    ...
    Popup {
        id: popup
        x:  pntPos.x>Screen.desktopAvailableWidth/2 ? root.width-width+5 : 0
        y:  pntPos.y>Screen.desktopAvailableWidth/2? root.height-height+7 : 0
        modal: true
        focus: true
        clip:  true
