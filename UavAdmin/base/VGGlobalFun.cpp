...
/////////////////////////////////////////////////////////////////////////////////////////////////////
bool VGGlobalFunc::IsBigEndian(void)
{
    const static FlagEnddian sFlag = { 1 };
    return sFlag.cData == sFlag.nFlag;
}

void VGGlobalFunc::gpsCorrect(double &lat, double &lon)
{
    ...
    double dLat;
    double dLon;
    calculateOffset(lat, lon, dLat, dLon);
    lat += dLat;
    lon += dLon;
}

void VGGlobalFunc::toGps(double &lat, double &lon)
{
    if (outOfChina(lat, lon))
        return;
