...
QString VGFlyRoute::GetTime() const
{
    return VGMainPage::GetTimeString(m_time);
}

qint64 VGFlyRoute::GetMsTime() const
{
    return m_time;
}
...
int VGFlyRoute::CountRidges() const
{
    return m_ridgeOper;
}

float VGFlyRoute::GetAcreage() const
{
...
void VGFlyRoute::showPlanningResult(const VGRoute &result, VGFlyRoute *rt)
{
    if (rt != this)
        return;
