...
void VGLandManager::PreparePlanRoute(VGFlyRoute *fr)
{
    if (fr)
    {
        connect(s_planningWorker, &VGPlanningWorker::planFinished, fr, &VGFlyRoute::showPlanningResult, Qt::UniqueConnection);
