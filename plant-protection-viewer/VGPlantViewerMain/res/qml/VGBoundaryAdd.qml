...
Rectangle{
    ...
    VGTextButton{
        ...
        strText:                qsTr("Fix point of block")//qsTr("确定障碍点")
        boardCol:               "#F24D28"
        onBtnClicked:           {emit:clickedBtn(2)}
    }
    Text {
        id:     txtBd
        text:   qsTr("Point of boundary")//qsTr("边界点")
        anchors {left: seperater.right; leftMargin: 11; top:   seperater.top}
    }
    VGTextButton{
        id:                     btnClear
        anchors {left: txtBd.left; top: txtBd.bottom; topMargin: 5; right: parent.right; rightMargin: 11}
        height:                 implicitHeight  * 2
        strText:                qsTr("Clear all")//qsTr("清除所有")
        boardCol:               "#F24D28"
    ...
    VGTextButton{
        ...
        strText:                qsTr("Fix point of boundary")//qsTr("确定边界点")
        boardCol:               "#0b81ff"
