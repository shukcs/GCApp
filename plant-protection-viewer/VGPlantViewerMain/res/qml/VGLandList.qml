...
Rectangle{
    ...
    VGTextButton {
        ...
        strText:                qsTr("Add land")//qsTr("添加地块")
        visible:                !bSelect
                ...
                delegate: Rectangle{
                    ...
                    Column{
                        ...
                        Rectangle {
                            ...
                            Text {
                                ...
                                text:      qsTr("Blocks:")+object.countBlocks//qsTr("障碍物: ")
                                font:      vgMainPage.littleFont()
                                color:     "#605C5B"
                            }
                        }
                    ...
                    Column{
                        ...
                        Rectangle {
                            ...
                            Label {
                                text:                 object.landArea.toFixed(2) + qsTr("acre")//qsTr("亩")
