...
Rectangle {
    ...
    signal clickedOK(string dsc, VGLandInformation land)
        ...
        Column{
            ...
            Rectangle {
                ...
                VGTextField{
                    ...
                    placeholderText:            qsTr("Please input Land name")//qsTr("请输入地块名称")
                    font:                       vgMainPage.font()
            ...
            Rectangle {
                ...
                VGTextField{
                    ...
                    anchors {verticalCenter: parent.verticalCenter; right: parent.right; rightMargin: 20}
                    width:                      parent.width*3/5
                    placeholderText:            qsTr("Please input Owner name")//qsTr("请输入地主姓名")
                    font:                       vgMainPage.font()
                    onTextChanged:              checkWholeInfo()
                }
                Rectangle{
            ...
            Rectangle {
                ...
                Label{
                    anchors {verticalCenter: parent.verticalCenter; left: parent.left; leftMargin: 20}
                    text:                       qsTr("Phone number:")//qsTr("手机号:")
                    font:                       vgMainPage.font()
                    color:                      "gray"
                }
                VGTextField{
                    ...
                    anchors {verticalCenter: parent.verticalCenter; right: parent.right; rightMargin: 20}
                    width:                      parent.width*3/5
                    placeholderText:            qsTr("Please input phone number")//qsTr("请输入地主联系方式")
                    font:                       vgMainPage.font()
                    onTextChanged:              checkWholeInfo()
            ...
            Rectangle {
                ...
                Label{
                    anchors {verticalCenter: parent.verticalCenter; left: parent.left; leftMargin: 20}
                    text:                       qsTr("Survey source:")//qsTr("边界点来源:")
                    font:                       vgMainPage.font()
                    color:                      "gray"
                }
                VGComboBox{
                    ...
                    anchors {verticalCenter: parent.verticalCenter; right: parent.right; rightMargin: 20}
                    width:                      parent.width*3/5
                    model:  [qsTr("Plant survey"), qsTr("Draw"), qsTr("Beidu Survey"),qsTr("Chongqing RTK survey")]//已有测绘, 手动标点, 北斗伴侣踩点,重庆单频RTK测绘站)
