...
Rectangle{
    ...
    Text {
        id:     tip
        text:   qsTr("Select boundary point,add new point after it!")//"选择边界点，在之后添加新边界点!"
    ...
    VGTextButton{
        ...
        height:                 implicitHeight  * 1.5
        enabled:                bCoorSelect
        strText:                qsTr("Add boundary point")//"添加边界点"
        boardCol:               "#0b81ff"
