...
Page {
    ...
    Column{
        ...
        VGToolButton {
            ...
            onBtnClicked: {
                ...
                landInfo.headerName = qsTr("Survey outline")//qsTr("测绘地块外轮廓")
                onSurveyChanged()
            }
        }
        VGToolButton {
            ...
            onBtnClicked: {
                ...
                landInfo.headerName = qsTr("Survey block")//qsTr("测绘地块障碍物")
                onSurveyChanged()
            }
        }
        VGToolButton {
            ...
            onBtnClicked: {
                ...
                landInfo.headerName = qsTr("Survey")//qsTr("测绘")
                onSurveyChanged()
            }
        }
        VGToolButton {
            ...
            onBtnClicked: {
                ...
                landInfo.headerName = qsTr("Survey pause")//qsTr("测绘暂停")
                onSurveyChanged()
            }
        }
        VGToolButton {
            ...
            onBtnClicked: {
                ...
                if (page && landInfo)
                {
                    ...
                    vgMainPage.headerName = qsTr("Survey finish")//qsTr("完成地块测绘")
            ...
            Repeater{
                ...
                delegate: Rectangle{
                    ...
                    Column{
                        ...
                        Text {
                            id: describe
                            text:               object.address+qsTr(" (")+object.plantArea.toFixed(2) + qsTr("acre)")//qsTr("亩)")
                            font:               vgMainPage.font()
                        }
                    }
    ...
    MessageDialog{
        ...
        title:          qsTr("Survey tip")//qsTr("测绘提示")
        icon:           StandardIcon.Information
        onAccepted: {
            visible = false;
            if (landInfo && landInfo.surveyType===VGLandInformation.Survey_BanLv) {
    ...
    Connections{
        ...
        onErrorChanged:{
            ...
            {
                messageDialog.text = strError + qsTr(";link uav now?")//qsTr("；需要现在连接测绘设备么？")
                messageDialog.standardButtons = StandardButton.Ok|StandardButton.Close
            }
            if (landInfo.surveyType===VGLandInformation.Survey_BanLv)
            {
                messageDialog.text = strError + qsTr(";please check GPS is opened?")//qsTr("；请检查GPS是否打开？")
            }
            else
