    ...
    Rectangle{
        ...
        Column {
            ...
            Grid
            {
                ...
                spacing: 5
                Label{
                    text: qsTr("Cloud ID:")//qsTr("服务器上ID:")
                ...
                Label{
                    text: qsTr("Land address:")//qsTr("地块地址:")
                    font: vgMainPage.font()
                    verticalAlignment : Text.AlignVCenter|Text.Left
                }
                ...
                Label{
                    text: qsTr("Owner address:")//qsTr("地主地址:")
                    font: vgMainPage.font()
                    verticalAlignment : Text.AlignVCenter|Text.Left
                }
                VGTextField {
                ...
                Label{
                    text: qsTr("Owner phone:")//qsTr("地主手机:")
                    font: vgMainPage.font()
                    verticalAlignment : Text.AlignVCenter|Text.Left
                }
                VGTextField {
            ...
            Rectangle{
                ...
                Button {
                    ...
                    onClicked: {
                        ...
                        root.visible = false
                        vgMainPage.destroyQmlObject(root)
                        landInfo.headerName = qsTr("Survey finished")//qsTr("测绘完成")
                    }
                }
                Button {
                    id:                 btnOK
