...
const static double array1[] = { 75, 60, 45, 30, 15, 0 };
const static double array3[] = { 12890594.86, 8362377.87, 5591021, 3481989.83, 1678043.12, 0 };
const static double array2[6][10] = {{-0.0015702102444, 111320.7020616939, 1704480524535203, -10338987376042340, 26112667856603880, -35149669176653700, 26595700718403920, -10725012454188240, 1800819912950474, 82.5}
...
const static double array4[6][10] = {{1.410526172116255e-8, 0.00000898305509648872, -1.9939833816331, 200.9824383106796, -187.2403703815547, 91.6087516669843, -23.38765649603339, 2.57121317296198, -0.03801003308653, 17337981.2}
 ...
 * */
const static QPoint g_arrayBaidu[19] = {QPoint(0, 0), QPoint(0, 0), QPoint(0, 0), QPoint(1, 0),
...
const static QPoint g_arrayGoogle[19] = {QPoint(0, 0), QPoint(1, 0), QPoint(3, 1), QPoint(6, 2),
