...
static void mavlink_test_qxsdk_account(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_QXSDK_ACCOUNT >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_qxsdk_account_t packet_in = {
        963497464,"EFGHIJKLMNOPQRS",{ 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90, 91, 92, 93, 94, 95, 96 },161,228
    };
    mavlink_qxsdk_account_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.devid = packet_in.devid;
        packet1.type = packet_in.type;
        packet1.sdkserver = packet_in.sdkserver;
        
        mav_array_memcpy(packet1.akey, packet_in.akey, sizeof(char)*16);
        mav_array_memcpy(packet1.asec, packet_in.asec, sizeof(uint8_t)*32);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_QXSDK_ACCOUNT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_QXSDK_ACCOUNT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qxsdk_account_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_qxsdk_account_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qxsdk_account_pack(system_id, component_id, &msg , packet1.akey , packet1.asec , packet1.devid , packet1.type , packet1.sdkserver );
    mavlink_msg_qxsdk_account_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qxsdk_account_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.akey , packet1.asec , packet1.devid , packet1.type , packet1.sdkserver );
    mavlink_msg_qxsdk_account_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_qxsdk_account_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qxsdk_account_send(MAVLINK_COMM_1 , packet1.akey , packet1.asec , packet1.devid , packet1.type , packet1.sdkserver );
    mavlink_msg_qxsdk_account_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_qxsdk_acc_cmd(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_QXSDK_ACC_CMD >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_qxsdk_acc_cmd_t packet_in = {
        5
    };
    mavlink_qxsdk_acc_cmd_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.sdkcmd = packet_in.sdkcmd;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_QXSDK_ACC_CMD_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_QXSDK_ACC_CMD_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qxsdk_acc_cmd_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_qxsdk_acc_cmd_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qxsdk_acc_cmd_pack(system_id, component_id, &msg , packet1.sdkcmd );
    mavlink_msg_qxsdk_acc_cmd_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qxsdk_acc_cmd_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sdkcmd );
    mavlink_msg_qxsdk_acc_cmd_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_qxsdk_acc_cmd_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qxsdk_acc_cmd_send(MAVLINK_COMM_1 , packet1.sdkcmd );
    mavlink_msg_qxsdk_acc_cmd_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_interrupt_point(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_INTERRUPT_POINT >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_interrupt_point_t packet_in = {
        963497464,963497672,963497880,41
    };
    mavlink_interrupt_point_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.int_latitude = packet_in.int_latitude;
        packet1.int_longitude = packet_in.int_longitude;
        packet1.int_altitude = packet_in.int_altitude;
        packet1.int_type = packet_in.int_type;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_INTERRUPT_POINT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_INTERRUPT_POINT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_interrupt_point_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_interrupt_point_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_interrupt_point_pack(system_id, component_id, &msg , packet1.int_latitude , packet1.int_longitude , packet1.int_altitude , packet1.int_type );
    mavlink_msg_interrupt_point_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_interrupt_point_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.int_latitude , packet1.int_longitude , packet1.int_altitude , packet1.int_type );
    mavlink_msg_interrupt_point_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_interrupt_point_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_interrupt_point_send(MAVLINK_COMM_1 , packet1.int_latitude , packet1.int_longitude , packet1.int_altitude , packet1.int_type );
    mavlink_msg_interrupt_point_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_interrupt_point_ack(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_INTERRUPT_POINT_ACK >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_interrupt_point_ack_t packet_in = {
        5
    };
    mavlink_interrupt_point_ack_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.ack_value = packet_in.ack_value;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_INTERRUPT_POINT_ACK_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_INTERRUPT_POINT_ACK_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_interrupt_point_ack_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_interrupt_point_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_interrupt_point_ack_pack(system_id, component_id, &msg , packet1.ack_value );
    mavlink_msg_interrupt_point_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_interrupt_point_ack_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.ack_value );
    mavlink_msg_interrupt_point_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_interrupt_point_ack_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_interrupt_point_ack_send(MAVLINK_COMM_1 , packet1.ack_value );
    mavlink_msg_interrupt_point_ack_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_get_obstacle_info(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_GET_OBSTACLE_INFO >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_get_obstacle_info_t packet_in = {
        5
    };
    mavlink_get_obstacle_info_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.obs_type = packet_in.obs_type;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_GET_OBSTACLE_INFO_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_GET_OBSTACLE_INFO_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_get_obstacle_info_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_get_obstacle_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_get_obstacle_info_pack(system_id, component_id, &msg , packet1.obs_type );
    mavlink_msg_get_obstacle_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_get_obstacle_info_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.obs_type );
    mavlink_msg_get_obstacle_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_get_obstacle_info_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_get_obstacle_info_send(MAVLINK_COMM_1 , packet1.obs_type );
    mavlink_msg_get_obstacle_info_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_obstacle_info(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_OBSTACLE_INFO >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_obstacle_info_t packet_in = {
        { 963497464, 963497465, 963497466 },{ 963498088, 963498089, 963498090 },{ 963498712, 963498713, 963498714 },{ 963499336, 963499337, 963499338 },149,216
    };
    mavlink_obstacle_info_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.obs_count = packet_in.obs_count;
        packet1.obs_danger_id = packet_in.obs_danger_id;
        
        mav_array_memcpy(packet1.obs_lat, packet_in.obs_lat, sizeof(int32_t)*3);
        mav_array_memcpy(packet1.obs_lon, packet_in.obs_lon, sizeof(int32_t)*3);
        mav_array_memcpy(packet1.obs_distance, packet_in.obs_distance, sizeof(int32_t)*3);
        mav_array_memcpy(packet1.obs_azi, packet_in.obs_azi, sizeof(int32_t)*3);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_OBSTACLE_INFO_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_OBSTACLE_INFO_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_obstacle_info_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_obstacle_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_obstacle_info_pack(system_id, component_id, &msg , packet1.obs_lat , packet1.obs_lon , packet1.obs_distance , packet1.obs_azi , packet1.obs_count , packet1.obs_danger_id );
    mavlink_msg_obstacle_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_obstacle_info_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.obs_lat , packet1.obs_lon , packet1.obs_distance , packet1.obs_azi , packet1.obs_count , packet1.obs_danger_id );
    mavlink_msg_obstacle_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_obstacle_info_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_obstacle_info_send(MAVLINK_COMM_1 , packet1.obs_lat , packet1.obs_lon , packet1.obs_distance , packet1.obs_azi , packet1.obs_count , packet1.obs_danger_id );
    mavlink_msg_obstacle_info_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_qxsdk_account(system_id, component_id, last_msg);
    mavlink_test_qxsdk_acc_cmd(system_id, component_id, last_msg);
    mavlink_test_interrupt_point(system_id, component_id, last_msg);
    mavlink_test_interrupt_point_ack(system_id, component_id, last_msg);
    mavlink_test_get_obstacle_info(system_id, component_id, last_msg);
    mavlink_test_obstacle_info(system_id, component_id, last_msg);
}
