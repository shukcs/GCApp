...
/** @brief  */
#ifndef HAVE_ENUM_MAV_QXSDK_ACC_CMD
#define HAVE_ENUM_MAV_QXSDK_ACC_CMD
typedef enum MAV_QXSDK_ACC_CMD
{
   MAV_QXSDK_ACC_CMD_READ=0, /* read qxsdk akey asec devid and type | */
   MAV_QXSDK_ACC_CMD_CLEAR=1, /* clear qxsdk akey asec devid and type | */
   MAV_QXSDK_ACC_CMD_ENUM_END=2, /*  | */
} MAV_QXSDK_ACC_CMD;
#endif
...
#include "./mavlink_msg_qxsdk_account.h"
#include "./mavlink_msg_qxsdk_acc_cmd.h"
#include "./mavlink_msg_interrupt_point.h"
#include "./mavlink_msg_interrupt_point_ack.h"
#include "./mavlink_msg_get_obstacle_info.h"
#include "./mavlink_msg_obstacle_info.h"
