...
// required uint32 stype = 3;
inline bool ParcelSurveyInformation::has_stype() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ParcelSurveyInformation::set_has_stype() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ParcelSurveyInformation::clear_has_stype() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ParcelSurveyInformation::clear_stype() {
  stype_ = 0u;
  clear_has_stype();
}
inline ::google::protobuf::uint32 ParcelSurveyInformation::stype() const {
  return stype_;
}
inline void ParcelSurveyInformation::set_stype(::google::protobuf::uint32 value) {
  set_has_stype();
  stype_ = value;
}
